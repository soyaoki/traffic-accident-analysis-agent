...
MASTER_MAPS = {
    ...
    "VEHICLE_TYPE": {
        1: "普通乗用車", 2: "普通貨物車", 3: "普通乗用車", 4: "軽乗用車", 5: "軽貨物車",
        11: "原付一種", 12: "原付二種", 13: "自転車", 14: "歩行者",
        17: "特定小型原動機付自転車", 21: "大型乗用車", 22: "大型貨物車",
        31: "中型乗用車", 32: "中型貨物車", 33: "準中型貨物車",
        41: "自動二輪", 51: "原付一種", 61: "その他"
    },
...
def init_db(force: bool = False):
    ...
    for year_dir in DATA_ROOT.glob("20*"):
        ...
        df["当事者種別名A"] = df["当事者種別（当事者A）"].map(MASTER_MAPS["VEHICLE_TYPE"]).fillna("不明")
